    ...
    return (
        <div>
            <Row>
                ...
                <Col xs={12} sm={12} md={12} className='mb-5 text-center' style={{ marginTop: '150px' }}>
                    <div>
                ...
                <Col xs={12} sm={12} md={12} className='yello-bg ' style={{ padding: '100px' }}>
                    <Row >
                        <Col xs={12} sm={12} md={6} style={{ marginTop: '-160px' }}>
